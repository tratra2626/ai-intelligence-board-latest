...
const events = [
  ...
  },
  {
    ...
    note: "阿里云官方文档公布 Qwen3.8-Max-Preview 预览可用与限时优惠口径，定位最新一代旗舰预览模型。",
    source: "https://help.aliyun.com/zh/lingma/qwen3-8-max-preview-limited-time-offer",
  },
  {
    date: "2026-07-21",
    company: "Google",
    model: "Gemini 3.6 Flash / 3.5 Flash-Lite / 3.5 Flash Cyber",
    note: "Google 发布新一代 Flash 系列，强调 token 效率、agent 任务成本与生产可靠性；Cyber 版本限受信合作方试点。",
...
const stWeeklyData = {
  ...
  overall: {
    ChatGPT: [43381, 43254, 43651, 43835, 44039, 44147, 45034, 44889, 45519, 45577],
    Dola: [1185, 1190, 1154, 1245, 1386, 1491, 1565, 1549, 1571, 1684],
    Claude: [1035, 1147, 1235, 1333, 1420, 1514, 1590, 1667, 1715, 1849],
    Gemini: [9036, 9424, 9718, 10036, 10248, 10510, 10982, 10987, 11225, 11681],
    Grok: [1235, 1182, 1152, 1157, 1163, 1191, 1023, 1036, 1064, 1062],
    Perplexity: [924, 931, 892, 886, 898, 874, 860, 856, 818, 808],
  },
  countries: {
    PH: {
      ChatGPT: [855, 795, 758, 769, 761, 768, 790, 796, 782, 779],
      Dola: [263, 216, 174, 186, 195, 205, 208, 201, 219, 230],
      Claude: [8, 9, 8, 8, 9, 10, 10, 11, 12, 11],
      Gemini: [184, 175, 167, 184, 187, 183, 196, 200, 197, 199],
      Grok: [11, 11, 11, 11, 14, 12, 11, 11, 12, 12],
      Perplexity: [12, 12, 11, 16, 14, 12, 12, 13, 11, 10],
    },
    ID: {
      ChatGPT: [1697, 1732, 1987, 2036, 2020, 2055, 2052, 2086, 2094, 2107],
      Dola: [319, 283, 350, 375, 380, 386, 414, 430, 390, 446],
      Claude: [39, 44, 53, 65, 74, 79, 75, 87, 80, 93],
      Gemini: [518, 532, 604, 614, 638, 648, 651, 660, 651, 705],
      Grok: [40, 37, 38, 40, 39, 36, 35, 34, 37, 37],
      Perplexity: [31, 36, 35, 32, 33, 34, 32, 30, 31, 37],
    },
    MX: {
      ChatGPT: [1479, 1479, 1303, 1361, 1503, 1519, 1463, 1493, 1508, 1532],
      Dola: [250, 241, 165, 203, 271, 293, 275, 239, 255, 309],
      Claude: [16, 17, 16, 19, 22, 24, 27, 24, 26, 27],
      Gemini: [403, 417, 385, 409, 454, 468, 495, 469, 463, 520],
      Grok: [38, 34, 32, 37, 36, 35, 33, 32, 33, 31],
      Perplexity: [16, 15, 17, 14, 16, 15, 16, 14, 16, 17],
    },
    GB: {
      ChatGPT: [811, 796, 797, 773, 782, 794, 801, 790, 789, 806],
      Dola: [45, 45, 52, 52, 58, 49, 55, 54, 59, 50],
      Claude: [30, 33, 35, 36, 40, 41, 46, 46, 47, 48],
      Gemini: [123, 125, 128, 130, 132, 132, 138, 143, 142, 148],
      Grok: [40, 38, 40, 40, 34, 36, 31, 33, 34, 33],
      Perplexity: [16, 15, 15, 15, 15, 14, 15, 15, 15, 14],
    },
    BR: {
      ChatGPT: [2853, 2823, 2842, 2870, 2905, 2830, 3009, 2960, 2997, 3021],
      Dola: [92, 100, 116, 126, 119, 165, 188, 195, 216, 242],
      Claude: [25, 32, 34, 35, 41, 42, 47, 49, 52, 56],
      Gemini: [546, 568, 589, 604, 610, 623, 650, 623, 633, 682],
      Grok: [61, 53, 53, 54, 55, 53, 49, 48, 48, 49],
      Perplexity: [53, 54, 51, 53, 52, 54, 53, 55, 47, 48],
    },
  },
};
...
const priceRows = [
  ...
  },
  {
    ...
    cached: null,
    output: 7.5,
    note: "Google 官方发布页价格；主打更高 token 效率、编码和多模态工作负载。",
    source: "https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-6-flash-3-5-flash-lite-3-5-flash-cyber/",
  },
  {
    company: "Google",
    ...
    cached: null,
    output: 2.5,
    note: "Google 官方发布页价格；定位高吞吐、低延迟 agentic workflow 和文档处理。",
    source: "https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-6-flash-3-5-flash-lite-3-5-flash-cyber/",
  },
  {
    company: "腾讯",
